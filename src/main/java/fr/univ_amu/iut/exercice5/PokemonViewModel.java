...
public class PokemonViewModel {
  ...
  public void ajouter() {
    ...
    Optional<Pokemon> estPresent = service.chercherParNom(recherche.get());
    ...
    estPresent.ifPresentOrElse(
        present -> {
          if (pokemons.contains(present)) statut.set("Déjà dans la liste.");
          else {
            pokemons.add(present);
            statut.set("");
            recherche.set("");
          }
        },
